...
if (isset($_POST['btn_submit'])) {
    if (isset($_GET['editid'])) {
        $sql = "UPDATE pasien_tindakan SET doctorid='$_POST[doctor]',catatan='$_POST[catatan]',treatmentid='$_POST[treatmentid]' WHERE nKode='$_GET[editid]'";
...
?>
        ...
        $sql = "INSERT INTO pasien_tindakan(appointmentid,patientid, doctorid, treatmentid, catatan) values('$_GET[appointmentid]','$_GET[patientid]','$_POST[doctor]','$_POST[treatmentid]','$_POST[catatan]')";
        if ($qsql = mysqli_query($conn, $sql)) {
        ...
        ?>
            <div class="popup popup--icon -success js_success-popup popup--visible">
                ...
                <div class="popup__content">
                    ...
                    <p>Tindakan Berhasil Disimpan</p>
                    <p>
                        <!--  <a href="index.php"><button class="button button--success" data-for="js_success-popup"></button></a> -->
                        <?php echo "<script>setTimeout(\"location.href = 'pasien_tindakan.php?patientid=$_GET[patientid]&appointmentid=$_GET[appointmentid]';\",3000);</script>"; ?>
                    </p>
                </div>
            </div>
<?php
                    ...
                    <div class="row align-items-end">
                        <div class="col-lg-8">
                            <div class="page-header-title">
                                <div class="d-inline">
                                    <h4>Tambah Tindakan Pasien A/n : <?php echo $rspx['patientname'] . "&nbsp" . "[ " . $rspx['patientid'] . " ]" ?></h4>
                        ...
                        <div class="col-lg-4">
                            <div class="page-header-breadcrumb">
                                <ul class="breadcrumb-title">
                                    ...
                                    <li class="breadcrumb-item"><a>Tambah Tindakan Pasien</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                                ...
                                <div class="card-block">
                                    <form id="main" method="post" action="" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-4">
                                                <select class="select2 form-control" name="treatmentid" id="treatmentid" required="">
                                                    ...
                                                    while ($rsdepartment = mysqli_fetch_array($qsqldepartment)) {
                                                        echo "<option value='$rsdepartment[treatmentid]'>$rs$rsdepartment[treatmenttype]</option>";
                                                    }
