    ...
    <div class="popup popup--icon -success js_success-popup popup--visible">
      ...
      <div class="popup__content">
        ...
        <p>
          ...
          <?php echo "<script>setTimeout(\"location.href = 'view-medicine.php';\",3000);</script>"; ?>
        </p>
      </div>
    </div>
<?php
          ...
          <div class="row align-items-end">
            <div class="col-lg-8">
              <div class="page-header-title">
                <div class="d-inline">
                  <h4 style="font-family: 'Unbounded', cursive;">List Obat</h4>
            ...
            <div class="col-lg-4">
              <div class="page-header-breadcrumb">
                <ul class="breadcrumb-title">
                  ...
                  <li class="breadcrumb-item"><a style="font-family: 'Unbounded', cursive;">List Obat</a>
                  </li>
                </ul>
              </div>
            </div>
