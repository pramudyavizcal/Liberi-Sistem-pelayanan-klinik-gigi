...
?>
            <div class="popup popup--icon -success js_success-popup popup--visible">
                ...
                <div class="popup__content">
                    ...
                    <p>
                        ...
                        <?php echo "<script>setTimeout(\"location.href = 'view-treatment.php';\",3000);</script>"; ?>
                    </p>
                </div>
            </div>
        <?php
        ...
        $sql = "INSERT INTO treatment(treatmenttype,treatment_cost,status) values('$_POST[treatmenttype]','$_POST[treatmentcost]','$_POST[status]')";
        if ($qsql = mysqli_query($conn, $sql)) {
        ?>
            <div class="popup popup--icon -success js_success-popup popup--visible">
                <div class="popup__background"></div>
                <div class="popup__content">
                    ...
                    <p>
                        <!--  <a href="index.php"><button class="button button--success" data-for="js_success-popup"></button></a> -->
                        <?php echo "<script>setTimeout(\"location.href = 'treatment.php';\",3000);</script>"; ?>
                    </p>
                </div>
            </div>
<?php
                    ...
                    <div class="row align-items-end">
                        <div class="col-lg-8">
                            <div class="page-header-title">
                                <div class="d-inline">
                                    <h4 style="font-family: 'Unbounded', cursive;">Tambah Tindakan</h4>
                        ...
                        <div class="col-lg-4">
                            <div class="page-header-breadcrumb">
                                <ul class="breadcrumb-title">
                                    ...
                                    <li class="breadcrumb-item"><a style="font-family: 'Unbounded', cursive;">Tambah Tindakan</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                                ...
                                <div class="card-block">
                                    <form id="main" method="post" action="" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control" placeholder="Input nama tindakan..." name="treatmenttype" id="treatmenttype" value="<?php if (isset($_GET['editid'])) {
                                                                                                                                            echo $rsedit['treatmenttype'];
                                                                                                                                        } ?>">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-sm-2 col-form-label">Tarif Tindakan</label>
                                            <div class="col-sm-8">
                                                <input type="number" class="form-control" placeholder="Input tarif tindakan..." name="treatmentcost" id="treatmentcost" value="<?php if (isset($_GET['editid'])) {
                                                                                                                                            echo $rsedit['treatment_cost'];
                                                                                                                                        } ?>" />
                                                <span class="messages"></span>
                                            </div>
                                        </div>
