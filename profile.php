...
if (isset($_POST["btn_update"])) {
  ...
  if ($_SESSION['user'] == 'admin') {
    $q1 = "UPDATE admin SET `fname`='$fname' where id = '" . $_SESSION["id"] . "'";
  }
          ...
          <div class="row align-items-end">
            <div class="col-lg-8">
              <div class="page-header-title">
                <div class="d-inline">
                  <h4 style="font-family: 'Unbounded', cursive;">Profil</h4>
            ...
            <div class="col-lg-4">
              <div class="page-header-breadcrumb">
                <ul class="breadcrumb-title">
                  ...
                  <li class="breadcrumb-item"><a style="font-family: 'Unbounded', cursive;">Profil</a>
                  </li>
                </ul>
              </div>
            </div>
                ...
                <div class="card-block">
                  <form id="main" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                      <label class="col-sm-2 col-form-label">Nama Administrator</label>
                      <div class="col-sm-4">
...
<span class="messages"></span>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-4">
                        <input type="number" class="form-control" id="contact" name="contact" value="<?php echo $mobileno; ?>" placeholder="Enter valid contact number..." minlength="10" maxlength="10" pattern="^[0][1-9]\d{9}$|^[1-9]\d{9}$">
                        <span class="messages"></span>
                      </div>
