            ...
            <div class="popup popup--icon -success js_success-popup popup--visible">
                ...
                <div class="popup__content">
                    ...
                    <p>
                        ...
                        <?php echo "<script>setTimeout(\"location.href = 'view-medicine.php';\",2000);</script>"; ?>
                    </p>
                </div>
            </div>
        <?php
                    ...
                    <div class="row align-items-end">
                        <div class="col-lg-8">
                            <div class="page-header-title">
                                <div class="d-inline">
                                    <h4 style="font-family: 'Unbounded', cursive;">Tambah Obat</h4>
                        ...
                        <div class="col-lg-4">
                            <div class="page-header-breadcrumb">
                                <ul class="breadcrumb-title">
                                    ...
                                    <li class="breadcrumb-item"><a style="font-family: 'Unbounded', cursive;">Tambah Obat</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                                ...
                                <div class="card-block">
                                    <form id="main" method="post" action="" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <input required type="text" class="form-control" placeholder="Input nama obat..." name="medicinename" id="medicinename" value="<?php if (isset($_GET['editid'])) {
                                                                                                                                                                                    echo $rsedit['medicinename'];
                                                                                                                                                                                } ?>">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-sm-2 col-form-label">Tarif Obat</label>
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control" placeholder="Input tarif obat..." name="medicinecost" id="medicinecost" value="<?php if (isset($_GET['editid'])) {
                                                                                                                                                                            echo $rsedit['medicinecost'];
                                                                                                                                                                        } ?>" />
                                                <span class="messages"></span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            <label class="col-sm-2 col-form-label">Deskripsi Obat</label>
                                            <div class="col-sm-8">
                                                <textarea maxlength="70" class="form-control" name="description" id="description"><?php if (isset($_GET['editid'])) {
